...
const LandingPage = () => {
  ...
  return (
    <div className="bg-white text-gray-800 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <ScrollReveal direction="up" className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We offer comprehensive web solutions to help your business thrive
      ...
      {/* About Section */}
      <section id="about" className="bg-blue-50 py-20 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <ScrollReveal direction="right" className="md:w-1/2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                digital marketers dedicated to helping businesses establish a
                powerful online presence.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                With years of experience in the industry, we've helped hundreds
                of businesses across various sectors transform their digital
