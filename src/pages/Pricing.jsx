        ...
        <div className="p-8">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-blue-600 font-bold">$990</td>
                  <td className="px-6 py-4 text-green-600 font-bold">
                    Up to 80% savings
                  </td>
                </tr>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-blue-800">
              ...
              streamlined development process and efficient workflow allow us to
              deliver professional, custom-built websites at a fraction of what
              traditional agencies charge. Say no more to overpriced websites!
            </p>
          </div>
        </div>
      </div>
...
const PricingMain = () => {
  ...
  const faqs = [
    ...
    {
      question:
        "Do you offer custom solutions and specific features beyond these plans?",
      answer:
  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          Affordable Website Pricing Plans | Starting at $49/month | NextGen
          Websites
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Website Pricing Plans | Save Up to 95% | NextGen Websites"
        />
        <meta
          property="og:description"
          content="Professional website development starting at $49/month with no upfront costs. Choose from Single Page, Multi Page, Advanced Business, or E-Commerce plans."
        />
        <meta
          property="og:image"
          content="https://www.nextgenwebsites.info/images/pricing-page-preview.jpg"
        />
        ...
        <meta
          ...
          content="Affordable Website Pricing | No Upfront Costs | NextGen Websites"
        />
        <meta
          property="twitter:description"
          content="Get a professional website from $49/month with no large upfront fees. Save up to 95% compared to traditional web development costs."
        />
        <meta
            ...
            <div className="container mx-auto px-6">
              <ScrollReveal direction="up" className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  A detailed breakdown of what's included in each plan to help
